 ...
 * Copyright  : Ctrip Copyright (c) 2016
 * Company    : Ctrip
 * Create at  : 2016/11/3 15:11
 * Description:
 */
public class McdRedisOperationsSessionRepository implements SessionRepository<McdRedisOperationsSessionRepository.RedisSession> {
    /**
     * The prefix for each key of the Redis Hash representing a single session. The suffix is the unique session id.
     */
    static  String BOUNDED_HASH_KEY_PREFIX = "spring:session:sessions:";
    ...
    public McdRedisOperationsSessionRepository(RedisConnectionFactory redisConnectionFactory) {
     ...
     */
    @SuppressWarnings("unchecked")
    public McdRedisOperationsSessionRepository(String prefix, RedisConnectionFactory redisConnectionFactory) {
        this(createDefaultTemplate(redisConnectionFactory));
        BOUNDED_HASH_KEY_PREFIX=BOUNDED_HASH_KEY_PREFIX+":"+prefix+":";
    }
    /**
     ...
     */
    public McdRedisOperationsSessionRepository(RedisOperations<String, ExpiringSession> sessionRedisOperations) {
     ...
     * {@link McdRedisOperationsSessionRepository.RedisSession#saveDelta()} is invoked
